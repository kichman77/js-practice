...
//   return this.engine;
// }
// console.log(new Car().getEngine());

// const myCar = new Car()
// console.log(myCar.getEngine());
...
//   email = "default")
// {
//   this.name = name;// инструкция котрая создаст свойство name в новом объекте и запишет в него значение из параметра name
//   //  name: "Harry",
//   this.age = age;
//   this.phone = phone;
//   this.email = email;
// // ТАК НЕЛЬЗЯ СОЗДАВАТЬ МЕТОДЫ В ФУНКЦИЯХ-КОНСТРУКТОРАХ
//   this.FindUser = function () {
//     console.log(this);
//   }
// }
// // МЕТОДЫ ЗАПИСЫВАЮТСЯ В ПРОТОТАЙП ФУНКЦИИ-КОНСТРУКТОРА
...
// наследование свойс __proto__ от предка
...
// const newPersone = new Persone("name", "height", "weight", "power", "skills")
// console.log(newPersone);
// const animal = {
//   name: "Lion",
// }
// animal.__proto__ = newPersone;
// console.log(animal);

// const elf = {
//   name: "charly",
// }
// elf.__proto__ = animal;
// console.log(elf);
// // -----------------------------------------------------------------

// наследование свойств фунукций-конструкторов

// const Impala = function (a, b) {
//   this.year = a;
//   this.engine = b;
// }
// const myCar = new Impala(1964, 325);
// console.log(myCar);

// const Delray = function (year, engine, z) {
//   Impala.call(this, year, engine);
//   this.color = z;
// }
// const myNewCar = new Delray(1968, 515, "black");
