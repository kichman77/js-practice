...
// const toPassTests = prompt(`Прежде, чем выполнить это задание у тебя должно быть сдано пять тестов!`);
// console.log(toPassTests);

const toPassTests = () =>  console.log(`Прежде, чем выполнить это задание у тебя должно быть сдано пять тестов!`);
